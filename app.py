...
def generer_rapport_kpi_pdf(kpi_data, df_reserve, carto_b64, logo_url):
    ...
    <div class="page">
        ...
        <div class="kpi-card">
            ...
            <p style="font-size:9pt;color:#64748B;margin-top:8px;">{k2['respectes']} réalisé(s) / {k1['restants']} non réalisé(s)
        ...
        <div class="kpi-card" style="border-left-color:#0EA5E9;">
            ...
            <p style="font-size:9pt;color:#64748B;margin-top:8px;">{k2['respectes']} respectés / {k2['respectes']} réalisé(s)</p>
        </div>
    </div>
